...
const Footer = () => {
    return (
        <Link to='/'>
            <footer className='bg-[#2B2A26] p-10'>
                <footer className="footer">
                    <nav>
                        <img className='w-[200px] h-[150px] rounded-md' src={logoPic} alt="" />
                    </nav>
                    <nav>
                ...
                <aside className='text-center'>
                    <p className='mt-5 text-gray-200'>Copyright © {new Date().getFullYear()} - All right reserved by FundSphere</p>
                </aside>
            </footer>
        </Link>
    );
